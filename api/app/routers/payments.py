...
from api.app.services.payments import new_checkout_session, apply_checkout_completed
...
async def create_checkout(
    ...
    try:
        url = await new_checkout_session(user.id, package_id)
...
async def stripe_webhook(
    ...
    if event["type"] == "checkout.session.completed":
        ...
        try:
            await apply_checkout_completed(
                db=db,
            ...
            raise HTTPException(500, "Failed to apply checkout completed") from e
